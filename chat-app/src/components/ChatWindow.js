...
import CustomAudioPlayer from "./MessagePlayer";
...
const ChatWindow = ({
  ...
  const handleAudioEnd = () => {
    console.log('Audio Ended'); // You can perform additional actions here if needed
              ...
              {msg.type === "text" ? (
                ...
                <div className="message-text">
                  {msg.data.type === "image/gif" ? (
                    ...
                    />
                  ) : msg.data.fileName.match(/\.(mp3|opus|wav)$/i) ? (
                    <div className="audio-player-container">
                     ...
                     audioUrl={URL.createObjectURL(
                      ...
                      href={URL.createObjectURL(new Blob([msg.data.fileContent], { type: msg.data.mimeType || "audio/mpeg" }))}
